...
public class SimplifiedChinese extends Language {
    public SimplifiedChinese() {
        ...
        yml.addDefault(Message.LOGIN_REQUIRED, "§a请登录: login <密码> <确认密码> (.或/均可)");
        yml.addDefault(Message.LOGIN_SUCESS, "§f玩家§a§l%player%§r登录啦\n欢迎~");
        ...
        yml.addDefault(Message.LOGIN_FAILED_UNREGISTERED, "§c无法登录,你还尚未进行注册");
